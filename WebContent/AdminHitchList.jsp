      ...
      <td height="500" align="center" valign="top"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form name="form1" method="post" action="AdminHitchList.action">
                ...
                <tr align="center"  class="t1">
                  ...
                  <s:iterator id="aa" value="list">
                    <tr align="center">
                      ...
                      <td>${Rperson}</td>
                      <td>${Rtime}</td>
                      <td align="center"><a href="AdminHitchCheck.action?Ano=${Ano}&Dno=${Dno}&Htype=${Htype}&Htime=${Htime}" ><span style="color:red">委任</span></a></td>
                      </tr>
                  </s:iterator>
              </table></td>
            </tr>
