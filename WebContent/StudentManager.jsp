              ...
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form name="form1" method="post" action="StudentManager.action">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr align="center"  class="t1">
                    ...
                    <td bgcolor="#D5E4F4"><strong>楼号</strong></td>
                    <td bgcolor="#D5E4F4"><strong>宿舍号</strong></td>
                    <td bgcolor="#D5E4F4"><strong>床号</strong></td>
                    <td bgcolor="#D5E4F4"><strong>联系电话</strong></td>
                    <td bgcolor="#D5E4F4"><strong>班主任联系电话</strong></td>
                  ...
                  <s:iterator id="aa" value="list">
                    <tr align="center">
                      ...
                      <td align="center">${Ttel}</td>
                      <td align="center"><a href="StudentUpdate.action?Sno=${Sno}"><span style="color:red">修改</span></a> <a href="StudentDel.action?Sno=${Sno}" onClick="return confirm('确定要删除该学生吗？')"><span style="color:red">删除</span></a></td>
                    </tr>
                  </s:iterator>
                </table></td>
            </tr>
